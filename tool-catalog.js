...
function getToolCatalog() {
  ...
  const tools = [
    ...
    tool("getCyberbossMonitorSnapshot", "Get a bounded root-backed, read-only Cyberboss monitoring snapshot: service/journal, resources, per-request model usage, work runs, delivery queue, and background continuity/NCP evidence. This never exposes credentials or an arbitrary root shell.", { hours: { type: "integer", minimum: 1, maximum: 12, default: 3 }, journal_lines: { type: "integer", minimum: 20, maximum: 500, default: 200 }, recent_requests_limit: { type: "integer", minimum: 1, maximum: 50, default: 20 }, recent_requests_offset: { type: "integer", minimum: 0, default: 0 } }),
