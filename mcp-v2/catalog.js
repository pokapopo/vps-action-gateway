...
function getCoreCatalog() {
  return [
    ...
    coreTool("observe", "Observe the system, Cyberboss, or logs. Select with view; put capability-specific fields in arguments.", "view"),
    coreTool("edit", "Create, replace, or patch ordinary files and scripts without approval; SHA guards still prevent stale overwrites. Select with action.", "action", WRITE),
